...
namespace kepler {
	...
	EditorCamera::EditorCamera(const Vec3f& position, const Vec3f& focalPoint, const float distance, const float fovY, const float aspect, const float nearClip, const float farClip)
		: m_pitch{ 0.0f }
		, m_yaw{ 0.0f }
		, m_lastCursorX{ -1.0f }
		, m_lastCursorY{ -1.0f }
