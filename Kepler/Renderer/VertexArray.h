...
namespace kepler {
	...
	public:
		...
		virtual void AddVertexBuffer(std::shared_ptr<IVertexBuffer> const vertexBuffer) = 0;
		virtual void SetIndexBuffer(std::shared_ptr<IIndexBuffer> const indexBuffer) = 0;
